    ...
    <>
      ...
      <div className="min-h-screen">
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="mb-12">
            <h2 className="mb-4">Value Creation Levers</h2>
            <p className="text-body max-w-2xl">
              Our operational approach focuses on four key areas that drive
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl">
            {levers.map((lever) => (
              <Card key={lever.title} className="p-8">
                <lever.icon className="h-8 w-8 text-accent mb-4" />
                <h3 className="text-xl mb-3">{lever.title}</h3>
                <p className="text-body">{lever.description}</p>
              </Card>
            ))}
          </div>
        </section>
